...
import com.yadneshDesale.musicPlayer.MusicAdapter.MyHolder
import com.yadneshDesale.musicPlayer.databinding.DetailsViewBinding
import com.yadneshDesale.musicPlayer.databinding.MoreFeaturesBinding
import com.yadneshDesale.musicPlayer.databinding.MusicViewBinding
...
class MusicAdapter(private val context: Context, private var musicList: ArrayList<Music>, private val playlistDetails: Boolean = false,
    ...
    // in onCreateViewHolder we are passing MusicViewBinding object so that music_view will be set as layout for each viewHolder in recyclerView
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        return MyHolder(MusicViewBinding.inflate(LayoutInflater.from(context), parent, false))
    }

    // Binding the data provided by the musicList which we are passing to the MusicAdapter to each viewHolder according the to position/index passed
